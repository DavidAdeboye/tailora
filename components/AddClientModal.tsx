      ...
      <div onClick={e => e.stopPropagation()} style={{ position: "relative", width: 514, background: "#fff", borderRadius: 16, overflow: "hidden", fontFamily: "Satoshi, Inter, sans-serif" }}>
        ...
        <div style={{ padding: "32px 30px 30px", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 16, marginTop: 28 }}>
            <button onClick={() => { onSaveDraft?.(form); onClose(); }} style={{ flex: 1, padding: "13px 24px", background: "transparent", border: "1px solid #121212", borderRadius: 999, fontSize: 14, fontWeight: 500, color: "#121212", fontFamily: "Satoshi, sans-serif", cursor: "pointer" }}
