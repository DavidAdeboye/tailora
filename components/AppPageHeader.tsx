  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
        <MobileMenuButton />
        <span className="tailora-header-title" style={{ fontFamily: "var(--font-sora)", fontWeight: 700, fontSize: 18, color: "#28292D" }}>{title}</span>
      </div>
      <div className="tailora-header-actions" style={{ display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
        <button
          type="button"
          className="tailora-header-bell-btn"
          style={{
            width: 40,
            height: 40,
            borderRadius: "50%",
