...
export default function SuccessModal({
  ...
  return (
    <div className="tailora-modal-backdrop" style={{ position: "fixed", inset: 0, background: "rgba(10,13,18,0.70)", backdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)", zIndex: 400, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div className="tailora-success-modal" style={{ position: "relative", width: 402, background: "#FFFFFF", borderRadius: 16, overflow: "hidden", fontFamily: "Satoshi, Inter, sans-serif", padding: "40px 30px 30px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 24, width: "100%" }}>
          {/* Green check */}
          <div className="tailora-success-icon" style={{ width: 80, height: 80, borderRadius: "50%", background: "#22C55E", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 24px rgba(34,197,94,0.25)" }}>
