...
const Desktop3: NextPage<Desktop3Type> = ({ className = "" }) => {
  return (
    <section
      className={`bg-foundation-secondary-light-active overflow-hidden flex flex-col items-start py-[100px] px-[184px] box-border max-w-full text-center text-xs text-foundation-primary-normal font-[Satoshi] mq800:py-[42px] mq800:px-[92px] mq800:box-border mq450:pl-5 mq450:pr-5 mq450:box-border mq1125:pt-[65px] mq1125:pb-[65px] mq1125:box-border ${className}`}
    >
      <div className="w-[1072px] flex flex-col items-center gap-10 max-w-full mq800:gap-5">
        <FrameComponent
        ...
        />
        <div className="self-stretch flex flex-col items-start gap-10 max-w-full mq800:gap-5">
          <section className="self-stretch flex items-center gap-10 max-w-full text-left text-lg text-foundation-primary-normal font-[Sora] mq800:gap-5 mq1350:flex-wrap">
            <MeasurementRows
          ...
          <section className="self-stretch flex items-center gap-10 max-w-full mq800:gap-5 mq1350:flex-wrap">
            <MeasurementRows
