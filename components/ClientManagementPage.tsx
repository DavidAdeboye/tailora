    ...
    <div className="tailora-page-view" style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
      ...
      <AppPageBody>
        <PageSectionHeader
          ...
          action={
            <div className="tailora-page-section-actions" style={{ display: "flex", gap: 10, alignItems: "center", position: "relative", zIndex: 100 }}>
              <div className="tailora-export-menu-wrapper" style={{ position: "relative", zIndex: 101 }}>
                <button
                  ref={exportBtnRef}
                  type="button"
                  onClick={handleToggleExportMenu}
                  className="tailora-export-btn"
                  style={{
                    padding: "10px 16px",
                    borderRadius: 999,
        ...
        {showExportMenu && isMounted && createPortal(
          <>
            <div
              className="tailora-export-backdrop"
              onClick={() => setShowExportMenu(false)}
              style={{ position: "fixed", inset: 0, background: "rgba(10, 13, 18, 0.45)", zIndex: 99998, backdropFilter: "blur(2px)" }}
            />
            <div
              ref={exportMenuRef}
              className="tailora-export-menu-card"
              style={{
                position: "fixed",
                top: menuCoords ? menuCoords.top : 140,
                left: menuCoords ? menuCoords.left : 16,
                background: "#fff",
            ...
            >
              <div className="tailora-export-sheet-header">
                <div className="tailora-export-sheet-handle" />
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8, padding: "0 4px" }}>
                  <span style={{ fontSize: 16, fontWeight: 700, color: "#101928", fontFamily: "var(--font-sora)" }}>
                    Export / Sync
                  </span>
                  <button
                    type="button"
                    onClick={() => setShowExportMenu(false)}
                    style={{ background: "#F2F4F7", border: "none", borderRadius: "50%", width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#667185", fontWeight: 600 }}
                  >
                    ✕
                  </button>
                </div>
              ...
              <button
                ...
                className="tailora-export-option-btn"
              >
                <div className="tailora-export-icon-box" style={{ background: "#ECFDF5" }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#107C41" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div style={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
                  <span className="tailora-export-opt-title">Export as Excel / CSV</span>
                  <span className="tailora-export-opt-sub">Spreadsheet table (.csv)</span>
                </div>
              </button>
              ...
              <button
                ...
                className="tailora-export-option-btn"
              >
                <div className="tailora-export-icon-box" style={{ background: "#FFF1F2" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
                  <span className="tailora-export-opt-title">Export as PDF</span>
                  <span className="tailora-export-opt-sub">Printable document (.pdf)</span>
                </div>
              </button>
              ...
              <button
                type="button"
                onClick={() => { handleExportNotion(); setShowExportMenu(false); }}
                className="tailora-export-option-btn"
              >
                <div className="tailora-export-icon-box" style={{ background: "#F1F5F9" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
                  <span className="tailora-export-opt-title">Copy for Notion (Markdown)</span>
                  <span className="tailora-export-opt-sub">Formatted Markdown text</span>
                </div>
              </button>

              <button
                type="button"
                onClick={() => { handleExportAppleNotes(); setShowExportMenu(false); }}
                className="tailora-export-option-btn"
              >
                <div className="tailora-export-icon-box" style={{ background: "#FEF3C7" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
                  <span className="tailora-export-opt-title">Export to Apple Notes</span>
                  <span className="tailora-export-opt-sub">Formatted text for Notes</span>
                </div>
              </button>
              ...
              <button
                type="button"
                onClick={() => setShowExportMenu(false)}
                className="tailora-export-sheet-cancel-btn"
              >
                Cancel
              </button>
            </div>
