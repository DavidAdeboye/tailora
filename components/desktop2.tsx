  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-col items-center gap-[62px] max-w-full mq800:gap-[31px] mq450:gap-[15px]">
        ...
        <div className="flex flex-col items-center gap-10 max-w-full mq800:gap-5">
          <section className="w-[1214px] h-[347px] rounded-[40px] bg-[#e57301] overflow-hidden shrink-0 flex items-start pt-7 px-10 pb-[27px] box-border relative isolate gap-[109px] text-left text-[32px] text-[#fff] font-[Sora] mq800:gap-[27px] mq1350:gap-[54px]">
            ...
            <div className="h-[222.8px] w-[170.6px] absolute !!m-[0 important] top-[273.75px] left-[689px] rounded-[50%] border-[rgba(255,227,179,0.6)] border-solid border-[0px] box-border [transform:_rotate(-11.3deg)] [transform-origin:0_0] shrink-0" />
            <div className="h-[222.8px] w-[170.6px] absolute !!m-[0 important] top-[264.55px] left-[759.2px] rounded-[50%] border-[rgba(255,227,179,0.6)] border-solid border-[0px] box-border [transform:_rotate(-11.3deg)] [transform-origin:0_0] z-[1] shrink-0" />
            <div className="h-[222.8px] w-[170.6px] absolute !!m-[0 important] top-[255.35px] left-[829.5px] rounded-[50%] border-[rgba(255,227,179,0.6)] border-solid border-[0px] box-border [transform:_rotate(-11.3deg)] [transform-origin:0_0] z-[2] shrink-0" />
          ...
          <div className="flex items-center gap-10 max-w-full mq800:gap-5 mq1350:flex-wrap">
            <section className="h-[636px] w-[588px] rounded-3xl bg-[#7e015c] overflow-hidden shrink-0 flex flex-col items-end pt-[57px] px-10 pb-[41px] box-border relative isolate gap-10 max-w-full text-left text-[32px] text-[#fff] font-[Sora] mq800:gap-5 mq800:pt-[37px] mq800:pb-[27px] mq800:box-border">
              <Image
                className="w-[200px] h-[200px] absolute !!m-[0 important] top-[506px] left-[-86px] rounded-lg shrink-0"
                loading="lazy"
                width={200}
                height={200}
                sizes="100vw"
              ...
              />
              <Image
                className="w-[200px] h-[200px] absolute !!m-[0 important] top-[-84px] left-[504px] rounded-lg shrink-0"
                width={200}
                height={200}
                sizes="100vw"
                alt=""
              ...
              <Image
                className="w-[492px] h-[377px] absolute !!m-[0 important] top-[41px] left-[40px] rounded-2xl object-cover z-[2] shrink-0"
                width={492}
                height={377}
                sizes="100vw"
                alt=""
            ...
            <section className="h-[636px] w-[588px] rounded-3xl bg-[#007f61] overflow-hidden shrink-0 flex flex-col items-end pt-[474px] px-10 pb-[41px] box-border relative isolate gap-[348px] max-w-full text-left text-[32px] text-[#fff] font-[Sora] mq800:gap-[174px] mq800:pt-[200px] mq800:pb-5 mq800:box-border mq450:gap-[87px] mq1350:pt-[308px] mq1350:pb-[27px] mq1350:box-border">
              ...
              />
              <Image
                className="w-[200px] h-[200px] absolute !!m-[0 important] top-[401px] left-[-100px] shrink-0"
                width={200}
                height={200}
                sizes="100vw"
                alt=""
              ...
              <div className="w-[488px] h-[377px] absolute !!m-[0 important] top-[57px] left-[60px] rounded-2xl bg-[#66b39f] overflow-hidden shrink-0 z-[1]" />
              <Image
                className="w-[492px] h-[377px] absolute !!m-[0 important] top-[41px] left-[40px] rounded-3xl object-cover z-[2] shrink-0"
                width={492}
                height={377}
                sizes="100vw"
                alt=""
